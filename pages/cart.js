  ...
  return (
    <>
      ...
      <div className="flex flex-col items-center pb-10">
        <Head>
          <title>Coffin ECommerce - CartDrawer</title>
          <meta name="description" content={`Coffin ECommerce - Shopping cart`}/>
          <meta property="og:title" content="Coffin ECommerce - CartDrawer" key="title"/>
        </Head>
        <div className="
        ...
        ">
          <div className="pt-10 pb-8">
            <h1 className="text-5xl font-light">Your CartDrawer</h1>
          </div>
                      ...
                      return (
                        <div className="border-b py-10" key={item.id}>
                          <div className="flex items-center hidden md:flex">
                            ...
                            <Link href={`/product/${slugify(item.name)}`}>
                              <a aria-label={item.name}>
                                <p className=" m-0 pl-10 text-gray-600 w-80">
                                  {item.name}
                                </p>
                              </a>
                            </Link>
            ...
            <Link href="/checkout" className="flex flex-1 justify-end">
              <a aria-label="Check out">
                <div className="cursor-pointer flex items-center">
                  ...
                  <ArrowNarrowRightIcon width={35} className="text-gray-600"/>
                </div>
              </a>
            </Link>
          )}
