  ...
  return (
    <Col classes='py-12 ipad:flex-row w-full my-0 mx-auto'>
      ...
      <Col classes='pt-2 px-0 ipad:pl-10 pb-8 w-full ipad:w-1/2'>
        <Text h1 weight='light' classes='text-2xl ipad:text-2xl laptop:text-4xl mt-2 mb-3.5'>{name}</Text>
        ...
        <Text weight='bold' classes='text-2xl ipad:text-3xl laptop:text-4xl relative tracking-wide'>
          ${salePrice ? salePrice : price}
          {
            ...
            && (
              <Text
                span color='gray-400' weight='light'
                classes='text-base  absolute top-[-1%] ipad:top-[1px] ml-[10px] line-through'>
                ${price}
              </Text>
            )
          }
