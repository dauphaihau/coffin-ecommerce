      ...
      <Grid md={2} lg={6} gapx={12} css='mt-12'>
        ...
        <div className='laptop:col-span-3'>
          <div className='p-4 rounded-lg'>
            ...
            >
              <Input name='old' type='password' label='Old Password' register={register} errors={errors}/>
              <Input name='new' type='password' label='New Password' register={register} errors={errors}/>
