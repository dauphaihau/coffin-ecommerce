...
const CustomerReview = () => {
  ...
  return (
    <Col>
      ...
      <Row align='center'>
        <Text sx='3xl' weight='medium'>
          3.8
          <Text span classes="sr-only"> Average review score </Text>
        </Text>
        <Col classes="ml-4">
      ...
      <Grid sx={1} lg={1} classes="mt-8 gap-x-16 gap-y-12">
        ...
        <blockquote>
          <Col classes='ipad:flex-row'>
            <Row classes='sm:items-center sm:flex mr-12 laptop:w-[11.5%]'>
              <img
        ...
        <blockquote>
          <Col classes='ipad:flex-row'>
            <Row classes='sm:items-center sm:flex mr-12 laptop:w-[11%]'>
              <img
                className="h-10 w-10 rounded-full mr-3"
          ...
          <Col classes='ipad:flex-row mt-6 rounded-lg bg-gray-custom-52 p-4 '>
            <Row classes='sm:items-center sm:flex mr-12 laptop:w-[16%]'>
              <Text
                classes="h-10 w-10 flex-center text-white bg-black rounded-full mr-3"
              >D</Text>
              <Col>
                <footer className="mt-2">
        ...
        <blockquote>
          ...
          <Col classes='ipad:flex-row mt-6 rounded-lg bg-gray-custom-52 p-4 '>
            <Row classes='sm:items-center sm:flex mr-12 laptop:w-[25%]'>
              <Text
                classes="h-10 w-10 flex-center text-white bg-black rounded-full mr-3"
              >D</Text>
              <Col>
